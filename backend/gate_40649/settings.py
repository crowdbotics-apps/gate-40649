"""
Django settings for gate_40649 project.
...
WSGI_APPLICATION = 'gate_40649.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "gate_40649 API",
    "DESCRIPTION": "API documentation for gate_40649 App",
    "VERSION": "v1",
}
